                ...
                <div class="page-content fade-in-up">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-body">
                                    <a href="<?= base_url() ?>departamento/add" class="btn btn-info">Adicionar</a>
                                </div>
                            </div>

                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Lista de Departamentos</div>
                                            ...
                                            <?php foreach ($departamentos as $a) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-info" href="<?= base_url('departamento/editar/' . $a->id_departamento) ?>">Editar</a> 
                                                        <?php if ($a->estado == 0) { ?>
                                                            <a class="btn btn-success" href="<?= base_url('departamento/ativar/' . $a->id_departamento) ?>">Ativar</a>
                                                        <?php } else { ?>
                                                            <a class="btn btn-danger" href="<?= base_url('departamento/desativar/' . $a->id_departamento) ?>">Desativar</a> 
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
