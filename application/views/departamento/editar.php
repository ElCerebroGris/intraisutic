                ...
                <div class="page-content fade-in-up">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Atualizar Departamento</div>
                                ...
                                <div class="ibox-body">
                                    <form action="<?= base_url() ?>departamento/editarPost" method="POST">
                                        <div class="row">
                                            <input name="id_departamento" type="hidden" value="<?= $departamentos[0]->id_departamento ?>" />
                                            <div class="col-sm-6 form-group">
                                                <label>Descrição</label>
                                                <input value="<?= $departamentos[0]->descricao_departamento ?>" class="form-control" type="text" name="descricao" required="">
                                            </div>
                                        </div>
