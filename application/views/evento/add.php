                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                ...
                                <div class="ibox-body">                                    
                                    <form action="<?= base_url() ?>evento/addPost" method="POST">

                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                <label>Titulo</label>
                                                <input name="titulo" min="3" class="form-control" type="text" required="">
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Local</label>
                                                <input name="local" min="3" class="form-control" type="text" required="">
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="time" name="tempo_inicio" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="time" name="tempo_fim" class="form-control" />
                                            </div>
                                        </div>
