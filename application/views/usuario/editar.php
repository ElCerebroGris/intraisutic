                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                ...
                                <div class="ibox-body">                                    
                                    <form action="<?= base_url() ?>usuario/editarPost" method="POST">
                                        
                                        <div class="row">
                                            <input name="id_usuario" value="<?= $usuarios[0]->id_usuario ?>" type="hidden" />
                                            <div class="col-sm-6 form-group">
                                                <label>Nome de Usuario</label>
                                                <input value="<?= $usuarios[0]->nome_usuario ?>" name="nome_usuario" min="3" class="form-control" type="text" required="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                <label>Senha</label>
                                                <input value="<?= $usuarios[0]->senha ?>" name="senha" size="6" class="form-control" type="password" required="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                <label for="sel1">Pessoa:</label>
                                                <select name="id_pessoa" class="form-control" id="sel1">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <select name="id_nivel" class="form-control" id="sel1">
                                                    <?php foreach ($nivel as $n) {
                                                        ?>
                                                        <option value="<?= $n->id_nivel_usuario ?>"><?= $n->descricao_nivel_usuario ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
