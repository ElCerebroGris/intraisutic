                ...
                <div class="page-content fade-in-up">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Lista de Usuários</div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($usuarios as $a) {
                                                ?>
                                                <tr>
                                                    <td><a href="#"><?= $a->nome_usuario ?></a></td>
                                                    <td><?= $a->descricao_nivel_usuario ?></td>
                                                    <td><?= $a->descricao_departamento ?></td>
                                                    <td><?= $a->estado_usuario ?></td>
                                                    <td>
                                                        <a class="btn btn-info" href="<?= base_url('usuario/editar/' . $a->id_usuario) ?>">Editar</a>
                                                        <?php if ($a->estado_usuario == 0) { ?>
                                                            <a class="btn btn-success" href="<?= base_url('usuario/ativar/' . $a->id_usuario) ?>">Ativar</a>
                                                        <?php } else { ?>
                                                            <a class="btn btn-danger" href="<?= base_url('usuario/desativar/' . $a->id_usuario) ?>">Desativar</a> 
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
