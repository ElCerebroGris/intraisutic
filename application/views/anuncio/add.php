                ...
                <div class="page-content fade-in-up">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Adicionar Anuncio</div>
                                ...
                                <div class="ibox-body">                                    
                                    <form action="<?= base_url() ?>anuncio/addPost" method="POST">

                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                <label>Titulo</label>
                                                <input name="titulo_anuncio" min="3" class="form-control" type="text" required="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                <label>Descrição</label>
                                                <textarea name="descricao_anuncio" class="form-control" rows="3"></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                <label>Duração (dias)</label>
                                                <input type="number" name="duracao_dia" class="form-control" />
                                            </div>
                                        </div>
