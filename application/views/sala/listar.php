                ...
                <div class="page-content fade-in-up">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-body">
                                    <a href="<?= base_url() ?>sala/add" class="btn btn-info">Adicionar</a>
                                </div>
                            </div>

                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Lista de Salas</div>
                                ...
                                <div class="ibox-body">
                                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($salas as $a) {
                                                ?>
                                                <tr>
                                                    <td>
                                                        <?= $a->numero_sala ?></td>
                                                    <td><?= $a->descricao_sala ?></td>
                                                    <td><?= $a->telefone_sala ?></td>
                                                    <td><?= $a->estado ?></td>
                                                    <td>

                                                        <a class="btn btn-info" href="<?= base_url('sala/editar/' . $a->id_sala) ?>">Editar</a>    
                                                        <?php if ($a->estado == 0) { ?>
                                                            <a class="btn btn-success" href="<?= base_url('sala/ativar/' . $a->id_sala) ?>">Ativar</a>
                                                        <?php } else { ?>
                                                            <a class="btn btn-danger" href="<?= base_url('sala/desativar/' . $a->id_sala) ?>">Desativar</a> 
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
