                ...
                <div class="page-content fade-in-up">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Adicionar Pessoas</div>
                                ...
                                <div class="ibox-body">                                    
                                    <form action="<?= base_url() ?>pessoa/addPost" method="POST">
                                        
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                <label>Nome Completo</label>
                                                <input name="nome_pessoa" min="3" class="form-control" type="text" required="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                <label>Nº do BI</label>
                                                <input name="bi" min="3" class="form-control" type="text" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                <label>Email</label>
                                                <input name="email" min="3" class="form-control" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input name="telefone" min="3" class="form-control" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                <label for="sel1">Nivel Acadamico:</label>
