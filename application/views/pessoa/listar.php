                ...
                <div class="page-content fade-in-up">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-body">
                                    <a href="<?= base_url() ?>pessoa/add" class="btn btn-info">Adicionar</a>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($pessoas as $a) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $a->estado ?></td>
                                                    <td>
                                                        <a class="btn btn-info" href="<?= base_url('pessoa/editar/' . $a->id_pessoa) ?>">Editar</a>    
                                                        <?php if ($a->estado == 0) { ?>
                                                            <a class="btn btn-success" href="<?= base_url('pessoa/ativar/' . $a->id_pessoa) ?>">Ativar</a>
                                                        <?php } else { ?>
                                                            <a class="btn btn-danger" href="<?= base_url('pessoa/desativar/' . $a->id_pessoa) ?>">Desativar</a> 
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
